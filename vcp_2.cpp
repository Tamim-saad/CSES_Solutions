...
int main()
{
    ...
    {
        // count++;
        ll i, j, k, x, y, z, p, q, m, n, l, r,t,  l1, l2, r1, r2, ans, pos, flag, sum ;
        ll mini = lmax, maxi = -1, piv, temp, part, low, high, rem, prev, now, mid, bit;
